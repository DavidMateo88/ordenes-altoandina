...
async function loadDashboard() {
  try {
    const [empleados, rosters, licencias] = await Promise.all([
      fetch('https://gestion-altoandina.onrender.com/api/empleados', { headers: { 'Authorization': `Bearer ${token}` } }).then(res => res.json()),
      fetch('https://gestion-altoandina.onrender.com/api/rosters', { headers: { 'Authorization': `Bearer ${token}` } }).then(res => res.json()),
      fetch('https://gestion-altoandina.onrender.com/api/empleados/licencias', { headers: { 'Authorization': `Bearer ${token}` } }).then(res => res.json())
    ]);
...
async function loadEmpleados() {
  ...
  try {
    const response = await fetch(`https://gestion-altoandina.onrender.com/api/empleados?${query}`, {
...
async function loadRosters() {
  ...
  try {
    const response = await fetch(`https://gestion-altoandina.onrender.com/api/rosters?${query}`, {
      headers: { 'Authorization': `Bearer ${token}` }
    });
...
async function exportCombinedReport() {
  try {
    ...
    XLSX.writeFile(workbook, 'informe_combinado.xlsx');
...
async function showEditEmpleadoModal(id) {
  try {
    const response = await fetch(`https://gestion-altoandina.onrender.com/api/empleados/${id}`, {
      headers: { 'Authorization': `Bearer ${token}` }
    });
...
async function showLicenciasModal(id) {
  try {
    const response = await fetch(`https://gestion-altoandina.onrender.com/api/empleados/${id}/licencias`, {
      headers: { 'Authorization': `Bearer ${token}` }
    });
...
async function saveEmpleado() {
  ...
  try {
    ...
    const url = id ? `https://gestion-altoandina.onrender.com/api/empleados/${id}` : 'https://gestion-altoandina.onrender.com/api/empleados';
...
async function saveLicencia() {
  ...
  try {
    const response = await fetch(`https://gestion-altoandina.onrender.com/api/empleados/${id}/licencia`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`
...
async function showEditRosterModal(id) {
  try {
    const response = await fetch(`https://gestion-altoandina.onrender.com/api/rosters/${id}`, {
      headers: { 'Authorization': `Bearer ${token}` }
    });
...
async function loadEmpleadosSelect(selected = []) {
  ...
  try {
    ...
    const response = await fetch('https://gestion-altoandina.onrender.com/api/empleados?estado=activo', {
      headers: { 'Authorization': `Bearer ${token}` }
    });
    ...
    if (startDate && endDate) {
      const allRosters = await fetch('https://gestion-altoandina.onrender.com/api/rosters', {
        headers: { 'Authorization': `Bearer ${token}` }
      }).then(res => res.json());
      const allLicencias = await fetch('https://gestion-altoandina.onrender.com/api/empleados/licencias', {
        headers: { 'Authorization': `Bearer ${token}` }
      }).then(res => res.json());
